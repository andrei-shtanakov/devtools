...
терминализации недостижимой. Общий тип живёт в `governance.facts`, а этот
модуль классифицирует по нему ровно те примитивы, на которых стоит
терминализация заявки.
