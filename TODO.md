...
- [ ] Срез B: перенести правило области ревью в review-kit — `prose-paths.env` вендорится в `scripts/review/`, фильтр живёт в `local.sh` и накрывает три канала @owner:github:andrei-shtanakov @id:review-scope-kit-wave
      ...
      по флоту.
- [x] Правило области ревью объявлено харнесс-путём: PR, правящий `contracts/review-scope/`, не доходит ни до ревью, ни до мержа агентом @owner:github:andrei-shtanakov @id:review-scope-contract-is-harness-path @epic:eco.tooling — devtools#271, PR этой ветки
      ...
      Цена: впредь любая правка правила области ревью уходит человеку.
