...
- [ ] Новые модули «Предмета» DT доезжают в чек-лист обязательством, а не теряются между предметом поставки и наблюдаемым поведением @owner:github:andrei-shtanakov @id:task-bridge-subject-deliverables-unpinned @epic:eco.dark-factory
      ...
      **Разведка 2026-09-21: механически это сегодня невыполнимо.**
      ...
      Цена: это правка СХЕМЫ узла decomposition, а её обязана производить
      авторская сторона (узел пишет disp; промпта в devtools нет). То есть
      работа кросс-репная, и её объём — не «поправить мост».
