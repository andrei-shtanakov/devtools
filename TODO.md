...
- [ ] Политика подписи §I12 приходит из источника, который проверяющий не может изменить @owner:github:andrei-shtanakov @epic:eco.dark-factory @id:approver-policy-trusted-source
      ...
      Критерий закрытия: названо, откуда политика берётся и почему
      проверяющая сторона не может её подменить; либо — если
      недостижимо — в спеке §I12 и в CLAUDE.md прямо записано, что
      проверка является defense-in-depth и подписи не гарантирует, и
      формулировки, обещающие гарантию, исправлены.
