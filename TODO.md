...
- [ ] selfcheck S1: самодиагностика devtools — статические пробы, граф использования, дубли, LLM-вызовы, дельта; отчёт-only (спека `docs/superpowers/specs/2026-09-25-selfcheck-design.md`, план `docs/superpowers/plans/2026-09-26-selfcheck-s1.md`) @owner:github:andrei-shtanakov @id:selfcheck-s1 @epic:eco.tooling
