...
Пять minor круга 2 закрыты и не повторяются.
...
разумное число кругов; потолок кита пришлось поднимать дважды (500k →
800k байт). Кандидат в план: ограничение размера behaviour-узла или
