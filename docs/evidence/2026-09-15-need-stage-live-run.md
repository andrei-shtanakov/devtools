...
major medium confidence про `restore` и оба minor — остаются
**неподтверждённо закрытыми**: были ли они отработаны этими же
коммитами не проверено ревью-контуром; полный текст — в вердикте
ai-prosto на spec-runner#522 (голова `95ebf36`, до владельческих правок).
Это НЕ дополнительный круг терминального ревью — счёт кругов S6 остаётся
восемь (§ выше).
...
major medium confidence про `restore` и 2 minor остаются неподтверждённо
закрытыми (вердикт ai-prosto на #522, голова `95ebf36`). Четыре дефекта
...
с тремя неподтверждёнными находками круга 8 на смерженном бандле) — за
владельцем, как и было зафиксировано ранее в этом документе. Следующий
