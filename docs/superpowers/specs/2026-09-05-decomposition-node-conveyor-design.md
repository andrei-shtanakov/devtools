...
- **одна строка, а не два ключа.** Класс и санкция разбираются вместе либо не
  разбираются вовсе: два ключа дали бы достижимое состояние «класс без
  санкции», и забыть можно было бы ровно половину;
