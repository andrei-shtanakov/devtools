...
- **Бюджет платных прогонов: 1 полный review + 1 адресный recheck**
  ...
  вызова кита: нет маркера · прошлая голова совпала с текущей (диапазон
  пуст — иначе кит вышел бы нулём и обвязка опубликовала approve поверх
  доставленного request-changes) · прошлая голова недоступна локально или
  не предок текущей (force-push/rebase). Барьер сильнее режима: после
