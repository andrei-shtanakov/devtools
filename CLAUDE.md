...
- **Бюджет платных прогонов: 1 полный review + 1 адресный recheck**
  ...
  **Граница доверия при этом НЕ сужается**: киту уходит
  ...
  Барьер бюджета и stop rule в адресном режиме выполняются ДО любого
  успешного выхода, включая ветку прозы. У обычного прогона место прежнее —
  после fp-блока: отпечаток и наследование вердикта бесплатны, а ветка прозы
  срабатывает, лишь когда прозаический весь PR.
